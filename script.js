...
const CHAPTERS = {
    ...
    // --- Выбор: Активность ---
    { isChoice: true, speaker: "Алиса:", char: CHARACTERS.ALICE, choices: [
        { text: "Да, я бы хотела присоединиться.", nextIdx: 15, stats: { ambition: 1 } },
    ...
    { speaker: "Кирилл", text: "Взаимно. Сейчас Диана раздаст вам анкеты, заполните их и сдайте, а мы напишем вам позже.", char: CHARACTERS.KIRILL,nextIdx:23},
