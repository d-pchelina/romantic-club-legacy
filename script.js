...
const CHAPTERS = {
    ...
    2: [
        ...
        { speaker: "Кирилл", text: "Рад видеть вас на этой встрече. В этом году мы набираем много новичков, так что шанс есть у каждого!", char: CHARACTERS.KIRILL },
        { speaker: "Кирилл", text: "Наш университет участвует в «Танцы-Шманцы» уже на протяжении 10 лет, 8 из которых мы выходили победителями. В этом году тоже планируем!", char: CHARACTERS.KIRILL },
        { speaker: "Кирилл", text: "Так что у вас тоже есть шанс стать победителями. Но учтите, что придется постараться, в команду на конкурс будет отдельный отбор среди всех участников клуба.", char: CHARACTERS.KIRILL },
        { speaker: "Диана", text: "Но не переживайте, для остальных, тоже найдется занятие. Мы проводим мастер-классы и участвуем в мероприятиях. Например, наши показательные выступления. ", char: CHARACTERS.DIANA },
        { speaker: "Диана", text: "Кстати, номер, который вы видели на приветственном дне, был организован нашим клубом!", char: CHARACTERS.DIANA },
        { speaker: "Кирилл", text: "Есть ли уже желающие пойти к нам?", char: CHARACTERS.KIRILL },

    // --- Выбор: Активность ---
    { isChoice: true, speaker: "Алиса:", char: CHARACTERS.ALICE, choices: [
        { text: "Да, я бы хотела присоединиться.", nextIdx: 18, stats: { ambition: 1 } },
        { text: "*Промолчать*", nextIdx: 19}
    ]},

    // Ветка 1: Подняла руку
    { speaker: "Кирилл", text: "Замечательно, красавица! Подойди ко мне сразу после мероприятия.", char: CHARACTERS.KIRILL, nextIdx: 20},
    
    // Ветка 2: Промолчала
    { speaker: "Кирилл", text: "Ну, если стесняетесь сейчас — подходите после, обсудим просмотр.", char: CHARACTERS.KIRILL,nextIdx: 24},
    ...
    { speaker: "Кирилл", text: "О, это ты, красавица. Приятно видеть таких смельчаков. Мы уже знакомы заочно, но хотелось бы лично. Я Кирилл.", char: CHARACTERS.KIRILL },
    { speaker: "Алиса", text: "Алиса. Очень приятно.", char: CHARACTERS.ALICE },
    { speaker: "Кирилл", text: "Взаимно. Сейчас Диана раздаст вам анкеты, заполните их и сдайте, а мы напишем вам позже.", char: CHARACTERS.KIRILL,nextIdx:26},
    ...
    { isChoice: true, speaker: "Алиса:", char: CHARACTERS.ALICE, choices: [
        { text: "*Попрощаться*", stats: { peak: 1 },nextIdx:28},
        { text: "*Уйти незаметно*", nextIdx:33}
    ]},
    ...
    // Результаты выбора
    { isChoice: true, speaker: "Алиса:", char: CHARACTERS.ALICE, choices: [
        { text: "Спасибо за предложение, звучит заманчиво.", nextIdx: 34, stats: { peak: 1 } },
        { text: "Спасибо за предложение, мы подумаем.", nextIdx: 34 },
        { text: "*Уйти*", nextIdx: 34, stats: { kirRel:-1 } }
    ]},
    ...
    3: [
    // --- Сцена 0: Опоздание ---
    { speaker: "Света", text: "Опаздываем. Неловко получается. Говорят, Виктор Андреевич тот еще душнила.", background: BACKGROUNDS.CORRIDOR, char: CHARACTERS.SVETA },
